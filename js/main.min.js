...
console.log("hoverLaSo");
    ...
    $("#viewMonth3,#inputYear").change(function() {
        ...
        $("#la-so-modal").html(e);
        var a = $(window).height();
        e.css("transform", `scale(${(a+150)/$("#table-la-so")[0].getBoundingClientRect().height}222) translate(0%)`), e.css("transform-origin", "50% 0"), e.css("left", "0");
...
function resizeLaSo() {
    ...
    const e = $("#content-la-so"),
        a = $("#table-la-so");
    if (t < 769) {
        if (a.css("-webkit-transform", `scale(${(t-50)/748}) translateX(-50%)`), a.css("-webkit-transform-origin", "0% 0"), a.length > 0) {
            const t = a.get(0);
    ...
    t >= 768 && t < 1024 ? $(".item-la-so").removeClass("col-6") : $(".item-la-so").addClass("col-6");
