        <div class="la-so-tu-vi container">
            <div class="container main">
                <div class="paper-roll">
                    <img class="page-edge-left" src="<?php echo get_template_directory_uri() ?>/images/page-edge.png">
                    <img class="page-edge-right" src="<?php echo get_template_directory_uri() ?>/images/page-edge.png">
                    <div class="page-roll"></div>
                    <div class="title-roll-background text-center">
                        <p class="paper-roll-title">Lập lá số Tử Vi</p>
                    </div>
                    <form class="form-paper-roll" id="form_la_so" method="post" action="<?php bloginfo('url'); ?>/la-so">
                        <div class="mb-1 col-lg-12">
                                                    <input type="hidden" name="loai" value="content">

                            <label class="txt-sub-content-mid mb-1">Họ Tên</label>
                            <input class="form-control form-control-custom txt-sub-content" name="ho_ten" type="text"
                        ...
                        <!-- <div class="mb-1 col-lg-12">
                            <div class="row">
                                ...
                                <button type="submit" class="btn col-lg-6"
                                    style="background-color: #928217;color: #FFF;font-family: 'tuv noh carbone';">
                                    Lập lá số
                                </button>
                                <div class="col-lg-3"></div>
                            </div>
            ...
            <div class="table-la-so container">
                <div class="list-tools col-lg-12">
                                        <?php if ( dynamic_sidebar('boxLink') ) : else : endif;  ?>
        ...
        <section class="section container" id="">
            ...
            <div class="section-content relative">
                            <?php if ( dynamic_sidebar('homeCategoryLinkAll') ) : else : endif;  ?>
